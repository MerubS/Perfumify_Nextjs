    ...
    return (
            <div className="min-h-screen flex items-center justify-center bg-white">
              <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                ...
                <p className="text-sm text-gray-300"> Don't have an account yet? </p>
                <Link href="/Pages/UserAuthentication/Registration"> <p className="text-sm text-gray-300"> Create Account </p> </Link>
              </div>
            </div>
    );
}